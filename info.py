...
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1002280543107'))

# Feature Specific Logs
PREMIUM_LOGS = int(environ.get("PREMIUM_LOGS", '-1002635844390'))
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002607653825'))
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1002457492650"))

# Auth Channels (Safe Parsing)
auth_channel_str = environ.get("AUTH_CHANNEL", "-1002327045567")
AUTH_CHANNEL = [int(x) for x in auth_channel_str.split()] if auth_channel_str else []

# =========================================================
# 🔗 LINKS & URLS
# =========================================================
CHANNEL = environ.get('CHANNEL', 'https://t.me/Indian_MV')
SUPPORT = environ.get('SUPPORT', 'https://t.me/Indian_MV_Group')
...
ENABLE_LIMIT = is_enabled(environ.get("ENABLE_LIMIT", "False"), True)
...
AUTH_PICS = environ.get('AUTH_PICS', 'https://i.ibb.co/1YNXCczC/IMG-20260217-162409-828.jpg')
PICS = environ.get('PICS', 'https://i.ibb.co/dwhxTHyt/Photo-1745758075249.png')
FILE_PIC = environ.get('FILE_PIC', 'https://i.ibb.co/dwhxTHyt/Photo-1745758075249.png')
...
MULTI_CLIENT = False
name = str(environ.get('name', 'IndianMV'))
...
if not URL or URL == "/":
    URL = "https://prior-dania-filetolinkmv-ab83e23d.koyeb.app/"
